...
- **Pattern recognition across <!-- AUTO-LC-COUNT -->68<!-- /AUTO-LC-COUNT --> LeetCode solutions** — two pointers, slow & fast, sliding window, Kadane's, Dutch National Flag, Moore's Voting, XOR, monotonic stack, priority queue, binary search, frequency counting, overflow bounds check, digit reversal, prefix sum, stack-based deletion.
- **Discipline** — <!-- AUTO-TOTAL-COUNT -->169<!-- /AUTO-TOTAL-COUNT --> solutions committed, CI-enforced strict-warnings compilation (`-Wall -Wextra -Wpedantic`) on every push.
...
**LeetCode by difficulty** (68 solved on [LeetCode profile](https://leetcode.com/u/madhan-x))
...
**Easy (2)**
- `baseball-game-stack.cpp` · `valid-parentheses-stack.cpp`
